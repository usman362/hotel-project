...
<div class="auth-inner row m-0">
                        ...
                        <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                            <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                                <h2 class="card-title fw-bold mb-1">Logged Out! 👋</h2>
                              <div class="demo-spacing-0">
                                    <div class="alert alert-primary" role="alert">
                                        <div class="alert-body"><strong>Hello!</strong> Login again to access your dashboard.</div>
                                    </div>
                                </div>
                                     <form method="POST" action="{{ theme()->getPageUrl('login') }}" class="auth-login-form mt-2" novalidate="novalidate" id="kt_sign_in_form">
                                        @csrf
                                    <div class="mb-1">
                                        <label class="form-label" for="login-email">Email</label>
                                        <input class="form-control" id="login-email" type="email" name="email" value="{{ old('email', 'demo@demo.com') }}" aria-describedby="login-email" autofocus="" tabindex="1" />
                                    </div>
                                    <div class="mb-1">
            ...
            @endif
                                    ...
                                    <div class="mb-1">
                                        <div class="form-check">
                                            <input class="form-check-input" id="remb-me" type="checkbox" tabindex="3" value="1"/>
 ...
 <script>
        ...
        document.getElementById('remb-me').onchange = function(e){
            if (document.getElementById('remb-me').checked){
                localStorage.setItem("remb-me", "1");
