...
@section('content')
  ...
  <div class="auth-inner row m-0">
                        ...
                        <form method="POST" action="{{ theme()->getPageUrl('password.update') }}" class="auth-reset-password-form mt-2" novalidate="novalidate" id="kt_new_password_form">
                            @csrf
                             ...
                             <input type="hidden" name="token" value="{{ $token }}">
                                    <div class="mb-1">
                                        <div class="d-flex justify-content-between">
                                             <input class="form-control form-control-solid" type="hidden" name="email" autocomplete="off" value="{{ old('email', $request->email) }}" />
