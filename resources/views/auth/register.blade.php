@push('styles')
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('app-assets/css/core.css') }}">
@endpush
@extends('auth.layout')
    ...
    <div class="auth-inner row m-0">
        ...
        <div class="col-lg-3 d-none d-lg-flex align-items-center p-0">
            <div class="w-100 d-lg-flex align-items-center justify-content-center">
                <img class="img-fluid w-100" src="{{ asset('app-assets/images/illustration/create-account.svg') }}"
                    alt="multi-steps" />
            </div>
        </div>
        <!-- /Left Text-->
                    ...
                    <div class="bs-stepper-content px-0 mt-4">
                        ...
                        <div id="personal-info" class="content" role="tabpanel" aria-labelledby="personal-info-trigger">
                            ...
                            <form action="register" method="POST" enctype="multipart/form-data" id="register">
                                ...
                                <input type="hidden" name="hidden-password">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 mb-1">
                                        ...
                                        <input type="text" name="mobile-number" id="mobile-number"
                                            class="form-control" placeholder="+1 472 765 3654" />
                                    </div>
                                    <div class="col-md-6 mb-1">
                                        <label class="form-label" for="select2-basic">Country</label>
                                        <select class="select2 form-select" id="select2-basic" name="country">
                                    ...
                                    <div class="col-md-12 mb-1">
                                        ...
                                        <div class="scout-element__date-select-container validity-con input-grp d-flex" data-type="date" data-direction="past" data-error="Please enter your date of birth">
                                            <div class="js-scout-element__date-select scout-element__date-select ml-4">
                                                <label class="form-label">Day</label>
                                                <select class="select2 form-select" name="dob-day" id="dob-day">
                                            ...
                                            <div class="js-scout-element__date-select scout-element__date-select ml-4">
                                                ...
                                                <select class="select2 form-select" name="dob-month" id="dob-month">
                                                    <option value="" selected disabled></option>
                                            ...
                                            <div class="js-scout-element__date-select scout-element__date-select ml-4">
                                                ...
                                                <select class="select2 form-select" name="dob-year" id="dob-year">
                                                    <option value="" selected disabled></option>
                                ...
                                <div class="card card-transaction">
                                    ...
                                    <div class="card-body">
                                        ...
                                        <div class="transaction-item">
                                            ...
                                            <div class="fw-bolder text-success email-text">name@domain.com</div>
                                        </div>
                                        <div class="transaction-item">
                                            <div class="d-flex align-items-center">
                                                <div class="avatar bg-light-success rounded me-1">
                                        ...
                                        <div class="transaction-item">
                                            ...
                                            <div class="fw-bolder text-success fullname-text">John Doe</div>
                                        </div>
                                        <div class="transaction-item">
                                            <div class="d-flex align-items-center">
                                                <div class="avatar bg-light-success rounded me-1">
                                            ...
                                            <div class="fw-bolder text-success phone-text">+977 9851094157</div>
                                        </div>
                                        <div class="transaction-item">
                                            <div class="d-flex align-items-center">
                                                <div class="avatar bg-light-success rounded me-1">
                                            ...
                                            <div class="fw-bolder text-success country-text">Nepal</div>
                                        </div>
                                        <div class="transaction-item">
                                            <div class="d-flex align-items-center">
                                                <div class="avatar bg-light-success rounded me-1">
                                            ...
                                            <div class="fw-bolder text-success dob-text">2002-07-22</div>
                                        </div>
                                        <div class="transaction-item">
                                            <div class="d-flex align-items-center">
                                                <div class="avatar bg-light-success rounded me-1">
                                            ...
                                            <div class="fw-bolder text-success gender-text">Male</div>
                                        </div>
                                        <div class="transaction-item">
                                            <div class="d-flex align-items-center">
                                                <div class="avatar bg-light-success rounded me-1">
                                            ...
                                            <div class="fw-bolder text-success zipcode-text">Rua Fernao Lourenco, 2800070, Almada,
                                                Portugal</div>
                                        </div>
...
@push('scripts')
    ...
    <script>
        $('.btn-next').click(function(){
            $('input[name=hidden-email]').val($('#email').val());
            $('input[name=hidden-password]').val($('#password').val());
            $('.email-text').text($('#email').val());
            $('.fullname-text').text($('#first-name').val()+' '+$('#last-name').val());
            $('.phone-text').text($('#phone').val());
            $('.country-text').text($('#country').val());
            $('.dob-text').text($('#dob-day').val()+'-'+$('#dob-month').val()+'-'+$('#dob-year').val());
            $('.gender-text').text($('#gender').val());
            $('.zipcode-text').text($('#zipcode').val());
        });
