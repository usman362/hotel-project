    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div  data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Add a Page</li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        {{-- <li class="breadcrumb-item">
                            <span class="bullet bg-gray-300 w-5px h-2px"></span>
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            <div id="kt_content_container" class="container-xxl">
                <form id="kt_ecommerce_add_category_form" method="post" enctype="multipart/form-data" action="{{route('page.store')}}"  class="form d-flex flex-column flex-lg-row">
                    @csrf
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <div class="mb-10 fv-row">
                                    ...
                                    <input type="text" name="title" class="form-control mb-2" placeholder="Page name" value="" />
                                </div>
                                <div class="mb-10 fv-row">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10">
                                    ...
                                    <textarea class="form-control" name="meta_desc" id="" cols="30" rows="5"></textarea>
                                </div>
                                <div>
                                    <label class="form-label">Meta Tag Keywords</label>
                                    <input name="meta_keywords" id="kt_ecommerce_add_category_meta_keywords" name="kt_ecommerce_add_category_meta_keywords" class="form-control mb-2" />
