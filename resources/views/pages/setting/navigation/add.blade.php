    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <form action="{{route('setting.addNavPost')}}" method="POST" enctype="multipart/form-data" id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" data-kt-redirect="../../demo1/dist/apps/ecommerce/catalog/categories.html">
                    @csrf
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <div class="mb-10 fv-row">
                                    <label class="required form-label">Nav Name</label>
                                    <input type="text" name="nav_name" class="form-control mb-2" placeholder="Nav Name"/>
                                </div>
                                <div class="mb-10 fv-row">
                                    <label class="required form-label">Nav Link</label>
                                    <input type="text" name="nav_link" class="form-control mb-2" placeholder="Nav Link"/>
                                </div>
                                <div class="mb-10 fv-row" >
                                    <label class="required form-label">Sub Nav</label>
                                    <div id="sub_navs">
                                        <div class="d-flex">
                                            <input type="text" name="sub_nav[]" class="form-control mb-2 mx-2" placeholder="Sub Nav Name" />
                                            <input type="text" name="sub_nav_link[]" class="form-control mb-2" placeholder="Sub Nav Link" />
                                        </div>
                                    </div>
...
<script src="https://stackpath.bootstrapcdn.com/bootstrap/3.4.1/js/bootstrap.min.js"></script>
    ...
    <script>
        ...
        document.getElementById('addMore').onclick = function(e){
            var main = document.getElementById('sub_navs');
            var div = document.createElement('div');
            div.setAttribute('class', 'd-flex');
            var input1 = document.createElement('input');
            input1.setAttribute('type', 'text');
            input1.setAttribute('name', 'sub_nav[]');
            input1.setAttribute('class', 'form-control mb-2 mx-2');

            var input2 = document.createElement('input');
            input2.setAttribute('type', 'text');
            input2.setAttribute('name', 'sub_nav_link[]');
