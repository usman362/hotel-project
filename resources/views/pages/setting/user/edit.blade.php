    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div  data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="Member-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Navigation</li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        {{-- <li class="breadcrumb-item">
                            <span class="bullet bg-gray-300 w-5px h-2px"></span>
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <form action="{{route('setting.UpdateUser', $user->id)}}" method="POST" enctype="multipart/form-data" id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row">
                    @csrf
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <div class="mb-10 fv-row">
                                    ...
                                    <input type="text" name="first_name" value="{{$user->first_name}}" class="form-control mb-2" placeholder="Nav Name"/>
                                </div>
                                <div class="mb-10 fv-row">
                                    <label class="required form-label">Last Name</label>
                                    <input type="text" name="last_name" value="{{$user->last_name}}" class="form-control mb-2" placeholder="Nav Name"/>
                                </div>
                                <div class="mb-10 fv-row">
                                    <label class="required form-label">Email</label>
                                    <input type="text" name="email" value="{{$user->email}}" class="form-control mb-2" placeholder="Nav Link"/>
                                </div>

                                <div class="fv-row mb-10 flex-row-fluid">
                                    <!--begin::Label-->
                                    <label class="required form-label">Role</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <select name="role" data-control="select2" data-hide-search="true" data-placeholder="Select an option" class="form-select" id="no_of_addon">
