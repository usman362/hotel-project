    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <form action="{{route('team.store')}}" method="POST" enctype="multipart/form-data" id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" data-kt-redirect="../../demo1/dist/apps/ecommerce/catalog/categories.html">
                    @csrf
                    <!--begin::Aside column-->
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="title" class="form-control mb-2" placeholder="Member name" value="" />
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="post" class="form-control mb-2" placeholder="Post" value="" />
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                    {{-- <div class="text-muted fs-7">A category name is required and recommended to be unique.</div> --}}
                                    <!--end::Description-->
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="profile_order" class="form-control mb-2" placeholder="Profile Order" value="" />
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                    {{-- <div class="text-muted fs-7">A category name is required and recommended to be unique.</div> --}}
                                    <!--end::Description-->
