    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div  data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="Member-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <!--begin::Title-->
                    <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Add Member</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Add a Member</li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        {{-- <li class="breadcrumb-item">
                            <span class="bullet bg-gray-300 w-5px h-2px"></span>
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            ...
            <div id="kt_content_container" class="container-xxl">
                <form action="{{route('team.update', $team->id)}}" enctype="multipart/form-data" method="POST" id="kt_ecommerce_add_category_form" class="form d-flex flex-column flex-lg-row" data-kt-redirect="../../demo1/dist/apps/ecommerce/catalog/categories.html">
                    @csrf
                    <!--begin::Aside column-->
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body text-center pt-0">
                                ...
                                @if ($team->avatar_image && !empty($team->avatar_image))
                                <div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true" style="background-image: url('{{asset('images/'.$team->avatar_image)}}')">
                                @else
                                <div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true" style="background-image: url('https://preview.keenthemes.com/metronic8/demo1/assets/media/svg/files/blank-image.svg')">
                                @endif
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <select name="status" class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select an option" id="kt_ecommerce_add_category_status_select">
                                    ...
                                    <option value="published" @if($team->status == 'published') selected @endif>Published</option>
                                    <option value="unpublished" @if($team->status == 'unpublished') selected @endif>Unpublished</option>
                                </select>
                                <!--end::Select2-->
                                <!--begin::Description-->
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="title" class="form-control mb-2" placeholder="Member name" value="{{$team->title}}" />
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                ...
                                <div class="mb-10 fv-row">
                                    <!--begin::Label-->
                                    <label class="required form-label">Post</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="post" class="form-control mb-2" placeholder="Post" value="{{$team->post}}" />
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                    {{-- <div class="text-muted fs-7">A category name is required and recommended to be unique.</div> --}}
                                    <!--end::Description-->
                                ...
                                <div class="mb-10 fv-row">
                                    <!--begin::Label-->
                                    <label class="required form-label">Profile Order</label>
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="profile_order" class="form-control mb-2" placeholder="Profile Order" value="{{$team->profile_order}}" />
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                    {{-- <div class="text-muted fs-7">A category name is required and recommended to be unique.</div> --}}
                                    <!--end::Description-->
                                ...
                                <div>
                                    ...
                                    <textarea name="description" class="form-control" id="summernote" cols="30" rows="5">{{$team->description}}</textarea>
                                    <!--end::Editor-->
                                    <!--begin::Description-->
