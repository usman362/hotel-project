                                ...
                                <form class="validate-form mt-2 pt-50" novalidate="novalidate">
                                    <div class="row">
                                        <div class="col-12 col-sm-3 mb-1">
                                            ...
                                            <input type="text" class="form-control" id="name" name="name" placeholder="Trekking" data-msg="Please enter activity name">
                                        </div>
                                        <div class="col-12 col-sm-3 mb-1">
                                        ...
                                        <div class="col-12 mb-1">
                                            <div id="full-wrapper">
                                                ...
                                                <div id="full-container">
                                                    <textarea class="tinymceTextEditor" name="description"></textarea>
                                                </div>
                                            </div>
                                        </div>
                                        <!-- Additional tabs-->
