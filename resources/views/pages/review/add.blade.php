                ...
                <div class="col-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body py-2 my-25">
                            <form class="validate-form mt-2 pt-50" action="{{route('review.store')}}" method="POST" novalidate="novalidate" enctype="multipart/form-data">
                         @csrf
                                <!-- header section -->
                            <div class="row">
                                <div class="col-md-4">
                            ...
                            <!-- form -->
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-md-6 mb-1">
                                        ...
                                        <input type="text" class="form-control" id="" name="title" placeholder="Best Trekking Company in Nepal" value="{{old('title')}}" data-msg="Please enter text">
                                    </div>
                                    <div class="col-12 col-sm-3 mb-1">
                                        <label class="form-label" for="accountLastName">Review Date</label>
                                        <input type="text" id="fp-default" name="date" value="{{old('date')}}" class="form-control flatpickr-basic" placeholder="YYYY-MM-DD" />
                                    ...
                                    <div class="col-12 col-md-3 mb-1">
                                        ...
                                        <div class="star-rating">
                                            <input type="radio" id="5-stars" name="rating" value="5" @checked(old('rating') == 5)/>
                                            <label for="5-stars" class="star">&#9733;</label>
                                            <input type="radio" id="4-stars" name="rating" value="4" @checked(old('rating') == 4)/>
                                            <label for="4-stars" class="star">&#9733;</label>
                                            <input type="radio" id="3-stars" name="rating" value="3" @checked(old('rating') == 3)/>
                                            <label for="3-stars" class="star">&#9733;</label>
                                            <input type="radio" id="2-stars" name="rating" value="2" @checked(old('rating') == 2)/>
                                            <label for="2-stars" class="star">&#9733;</label>
                                            <input type="radio" id="1-star" name="rating" value="1" @checked(old('rating') == 1)/>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-6">
                                            ...
                                            <div class="form-floating mb-0">
                                                <textarea data-length="60" class="form-control char-textarea" id="textarea-counter1" rows="1" name="meta_title" placeholder="Meta Title" style="height: 25px">{{old('meta_title')}}</textarea>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="form-floating mb-0">
                                                <textarea data-length="158" class="form-control char-textarea" id="textarea-counter" name="meta_description" rows="2" placeholder="Meta Description" style="height: 50px">{{old('meta_description')}}</textarea>
                                            </div>
                                        ...
                                        <div class="col-12">
                                            ...
                                            <div class="form-floating mb-0">
                                                <textarea data-length="250" class="form-control char-textarea" id="textarea-counter2" rows="2" name="meta_keywords" placeholder="Meta Keywords" style="height: 50px">{{old('meta_keywords')}}</textarea>
                                            </div>
