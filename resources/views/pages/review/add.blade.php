        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div  data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="Review-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <!--begin::Title-->
                    <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Add Review</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Add a Review</li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        {{-- <li class="breadcrumb-item">
                            <span class="bullet bg-gray-300 w-5px h-2px"></span>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <input type="text" name="review_title" class="form-control mb-2" placeholder="Review Title" />
                                </div>
                                <div class="mb-10 fv-row">
                                    <label class="required form-label">Reviewer Name</label>
                                    <input type="text" name="reviewer_name" class="form-control mb-2" placeholder="Reviewer Name" />
                                </div>
                                <div class="mb-10 fv-row">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="date" name="date" class="form-control mb-2" placeholder="Profile Order" value="" />
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <textarea name="content" class="form-control" id="summernote" cols="20" rows="5"></textarea>
                                    <!--end::Editor-->
                                    <!--begin::Description-->
