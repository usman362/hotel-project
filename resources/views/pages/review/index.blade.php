        ...
        <div class="content-header row">
            ...
            <div class="content-header-right text-md-end col-md-3 col-12 d-md-block d-none">
                <div class="mb-1 breadcrumb-right">
                    <a href="{{route('review.create')}}" class="btn btn-primary waves-effect waves-float waves-light">
                        <i data-feather="plus" class="me-25"></i>
                        <span>New Review</span></a>
                </div>
            </div>
        </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                          ...
                                          <label for="5-stars" class="star" style="color:#fc0">&#9733;</label>
                                          @endfor
                                        ...
                                        <td>
                                            <div class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-end">
                                                    ...
                                                    <a class="dropdown-item" href="{{route('review.delete',$review->id)}}">
