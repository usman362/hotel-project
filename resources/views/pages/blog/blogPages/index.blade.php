            ...
            <div class="row" id="table-bordered">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <p class="card-text">
                                Below is the list of <code>available blogs.</code> To add a new blog <code>click on the button above on the right</code> and then <code>click on + new blog</code> submenu. The blogs <code>can be edited</code> by <code>clicking on the 3 dots below</code> on the last column.
                            </p>
                        </div>
