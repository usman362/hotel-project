    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                <!--begin::Blog title-->
                <div  data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="Blog-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <!--begin::Title-->
                    <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Add Blog</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Add a Blog</li>
                        <!--end::Item-->
                        <!--begin::Item-->
                        {{-- <li class="breadcrumb-item">
                            <span class="bullet bg-gray-300 w-5px h-2px"></span>
                    ...
                    <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body text-center pt-0">
                                ...
                                <!--end::Image input-->
                                <!--begin::Description-->
                                <div class="text-muted fs-7">Set the Blog Banner image. Only *.png, *.jpg and *.jpeg image files are accepted</div>
                                <!--end::Description-->
                            </div>
                            <!--end::Card body-->
                        </div>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <select class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select an option" id="kt_ecommerce_add_category_status_select45">
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <select class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select an option" id="kt_ecommerce_add_category_status_select1_feature">
                                    <option></option>
                                    <option value="published" selected="selected">Yes</option>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <select class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select an option" id="kt_ecommerce_add_category_status_select">
                                    <option></option>
                                    <option value="published" selected="selected">Category-1</option>
                                </select>
                                <!--end::Select2-->
                                <!--begin::Description-->
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <tags class="tagify form-control mb-2 tagify--noTags tagify--empty" tabindex="-1" aria-expanded="false">
...
​
</tags><input id="kt_ecommerce_add_product_tags" name="kt_ecommerce_add_product_tags" class="form-control mb-2" value="">
                                <!--end::Input-->
                                <!--begin::Description-->
                                <div class="text-muted fs-7">Add tags to a blog.</div>
                                <!--end::Description-->
                                <!--end::Input group-->
                            </div>
                            <!--end::Card body-->
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <select class="form-select mb-2" data-control="select2" data-hide-search="false" data-placeholder="Select an option" id="kt_ecommerce_add_category_status_select_author">
                                    <option>Admin</option>
                                </select>
                            </div>
                        </div>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                <select class="form-select mb-2" multiple data-control="select2" data-hide-search="false" data-placeholder="Select an option" id="kt_ecommerce_add_category_status_select1">
                                    <option>test</option>
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10 fv-row">
                                    ...
                                    <!--end::Label-->
                                    <!--begin::Input-->
                                    <input type="text" name="category_name" class="form-control mb-2" placeholder="Blog name" value="" />
                                    <!--end::Input-->
                                    <!--begin::Description-->
                                ...
                                <div>
                                    ...
                                    <textarea name="t_notes" class="form-control" id="summernote" cols="30" rows="5"></textarea>
                                    <!--end::Editor-->
                                    <!--begin::Description-->
                        ...
                        <div class="card card-flush py-4">
                            ...
                            <div class="card-body pt-0">
                                ...
                                <div class="mb-10">
                                    ...
                                    <textarea name="t_notes" class="form-control" id="" cols="30" rows="5"></textarea>
                                    <!--end::Editor-->
                                    <!--begin::Description-->
