                                ...
                                <div class="row">
                                    <div class="col-12 col-sm-4 mb-1">
                                        ...
                                        <select class="form-select" id="basicSelect">
                                            ...
                                            <option>Everest High Passes Trek</option>
                                            <option>Annapurna Circuit Trekking</option>
                                    ...
                                    <div class="col-12 col-sm-3 mb-1">
                                        ...
                                        <input type="text" class="form-control" id="" name="" placeholder="Custom Tour Name" value="" data-msg="Please enter text">
                                    </div>
                                    ...
                                    <div class="col-12 col-sm-2 mb-1">
                                        ...
                                        <input type="text" class="form-control" id="" name="" placeholder="" value="XTRWMP" data-msg="Please enter text" disabled>
                                    </div>
                                    <div class="col-12 col-sm-3 mb-1">
                                    ...
                                    <div class="col-12 col-sm-3 mb-1">
                                        ...
                                        <input type="text" class="form-control" id="" name="" placeholder="John Smith" value="" data-msg="Please enter text">
                                    </div>
                                    <div class="col-12 col-sm-2 mb-1">
                                        <label class="form-label" for="accountLastName">Phone No</label>
                                        <input type="text" class="form-control" id="" name="" placeholder="+977 98510 94144" value="" data-msg="Please enter text">
                                    </div>
                                    <div class="col-12 col-sm-2 mb-1">
                                    ...
                                    <div class="col-12 col-sm-3 mb-1">
                                        ...
                                        <input type="text" class="form-control" id="" name="" placeholder="mynameis@gmail.com" value="" data-msg="Please enter text">
                                    </div>
                                    <div class="col-12 col-sm-3 mb-1">
                                    ...
                                    <div class="col-12 col-sm-2 mb-1">
                                        ...
                                        <input type="text" class="form-control" id="" name="" placeholder="12 Days" value="" data-msg="Please enter text">
                                    </div>
                                    <div class="col-12 col-sm-2 mb-1">
                                        <label class="form-label" for="accountLastName">Price Per Person</label>
                                        <input type="text" class="form-control" id="" name="" placeholder="USD 1312" value="" data-msg="Please enter text">
                                    </div>
                                    <div class="col-12 col-sm-2 mb-1">
