    ...
    <div class="container bg-white p-5">
        ...
        <form action="" method="post" class="form-control">
                <div class="form-group mb-5">
                  ...
                  <input type="email" class="form-control" placeholder="Lead Traveler">
                </div>
                ...
                <div class="form-group mb-5">
                    ...
                    <input type="text" class="form-control" placeholder="Name Of Trip">
                </div>
                <div class="form-group mb-5">
                ...
                <div class="form-group mb-5">
                    ...
                    <input type="number" class="form-control" placeholder="No Of Travelers">
                </div>
                <div class="form-group mb-5">
                    <label>Price Per Person</label>
                    <input type="number" class="form-control" placeholder="Price Per Person">
                </div>
                <div class="form-group mb-5">
                    <label>Deposited Price</label>
                    <input type="number" class="form-control" placeholder="Deposited Price">
                </div>
                <div class="form-group mb-5">
                    <label>Balance</label>
                    <input type="number" disabled class="form-control" placeholder="Balance">
                </div>
                <div class="form-group mb-5">
                    <label>Service Addons</label>
                    <input type="text" class="form-control" placeholder="Service Addons">
                </div>
                <div class="form-group mb-5">
                    <label>Notes</label>
    ...
    <div class="content d-flex flex-column flex-column-fluid" id="kt_content">
        ...
        <div class="toolbar" id="kt_toolbar">
            ...
            <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
                ...
                <div  data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                    <!--begin::Title-->
                    <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Add a Booking</h1>
                    <!--end::Title-->
                    <!--begin::Separator-->
                    ...
                    <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                        ...
                        <!--end::Item-->
                        <!--begin::Item-->
                        <li class="breadcrumb-item text-muted">Add a Booking</li>
                        <!--end::Item-->
                        <!--begin::Item-->
                       {{--  <li class="breadcrumb-item">
                            <span class="bullet bg-gray-300 w-5px h-2px"></span>
        ...
        <div class="post d-flex flex-column-fluid" id="kt_post">
            <div id="kt_content_container" class="container-xxl">
                <form method="POST" action="{{route('bookings.store')}}" class="form d-flex flex-column flex-lg-row">
                    @csrf
                            ...
                            <div class="card-body pt-0">
                                <div class="d-flex flex-column gap-10">
                                    @php
                                        ...
                                        shuffle($word);
                                        $rand = substr(implode($word), 0, 6);
                                    @endphp
                                    <div class="fv-row justify-content-between align-items-baseline d-flex">
                                        <label class="form-label">Reference ID</label>
                                        <div class="fw-bolder fs-3"><?= $rand ?></div>
                                        <input type="hidden" name="ref_id" value="<?= $rand; ?>">
                                    </div>
                                    <div class="fv-row">
                                    ...
                                    <div class="fv-row">
                                        ...
                                        <input type="number" class="form-control mb-2" name="price_per_person" id="price_per_person">
                                    </div>
                                    <div class="fv-row">
                                        <label class="required form-label">Deposit Per Person</label>
                                        <input type="number" class="form-control mb-2" name="deposit_per_person" id="deposit_per_person">
                                    </div>
                                    <div class="fv-row">
                                        <label class="required form-label">Balance Per Person</label>
                                        <input type="number" disabled class="form-control mb-2" name="balance_per_person" id="balance_per_person">
                                    </div>
                                    <div class="fv-row">
                                        <label class="required form-label">Booking Date</label>
                                        <input type="date" id="kt_ecommerce_edit_order_date" name="booking_date" placeholder="Select a date" class="form-control mb-2" value="" />
                                    </div>
                                </div>
                            </div>
                            <div class="card-body pt-0">
                                ...
                                <div class="d-flex flex-column gap-5 gap-md-7">
                                    <div class="d-flex flex-column align-items-baseline flex-md-row gap-5">
                                        <div class="flex-row-fluid w-25">
                                            ...
                                            <div class="d-flex justify-content-between gap-5">
                                                <div class="w-50">
                                                    <select class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select an option" name="l_t_name1" id="kt_ecommerce_edit_order_shipping">
                                                        <option></option>
                                                ...
                                                <div class="w-50">
                                                    <input type="text" class="form-control" name="l_t_name2" />
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="d-flex flex-column align-items-baseline flex-md-row gap-5">
                                        <div class="fv-row flex-row-fluid">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="email" class="form-control" name="l_t_email" />
                                            <!--end::Input-->
                                        </div>
                                        <div class="fv-row flex-row-fluid">
                                            <!--begin::Label-->
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="number" class="form-control" name="l_t_phone"/>
                                            <!--end::Input-->
                                        </div>
                                    </div>
                                    <div class="d-flex flex-column flex-md-row gap-5">
                                        ...
                                        <div class="fv-row flex-row-fluid w-50">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="date" class="form-control" name="l_t_date_birth" />
                                            <!--end::Input-->
                                        </div>
                                    </div>
                                    <div class="d-flex flex-column flex-md-row gap-5">
                                        <div class="flex-row-fluid w-50">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" class="form-control" name="t_name" placeholder="" value="" />
                                            <!--end::Input-->
                                        </div>
                                        <div class="fv-row flex-row-fluid w-50">
                                            <!--begin::Label-->
                                    ...
                                    <div class="d-flex flex-column flex-md-row gap-5">
                                        ...
                                        <div class="fv-row flex-row-fluid">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="number" class="form-control" name="addon_price_per_item" id="p_p_i" />
                                            <!--end::Input-->
                                        </div>
                                        <div class="fv-row flex-row-fluid w-25">
                                            ...
                                            <!--end::Label-->
                                            <!--begin::Input-->
                                            <input type="text" disabled class="form-control" name="addon_total_price" id="t_p" />
                                            <!--end::Input-->
                                        </div>
...
var dPP = document.getElementById('deposit_per_person');

pPP.onchange = function(e){
    var val = e.target.value;
    bPP.value = val-dPP.value; 
}
...
dPP.onchange = function(e){
    console.log(e)
    var val = e.target.value;
    bPP.value = pPP.value-dPP.value; 
}

dPP.onkeyup = function(e){
    var val = e.target.value;
    bPP.value = pPP.value-dPP.value; 
}
