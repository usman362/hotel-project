                                ...
                                <form class="validate-form mt-2 pt-50" novalidate="novalidate">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-12 col-md-3 mb-1">
                                            ...
                                            <input type="text" class="form-control" id="name" name="title" placeholder="Everest Region" data-msg="Please enter region name">
                                        </div>
                                        <div class="col-12 col-md-3 mb-1">
                                            <label class="form-label" for="accountLastName">URL Slug</label>
                                            <input type="text" class="form-control" id="url" name="url_slug" placeholder="/everest-region" value="" data-msg="Please enter URL">
                                        </div>
                                        ...
                                        <div class="col-12 col-md-10 mb-1">
                                            ...
                                            <input type="text" class="form-control" id="" name="banner_text" placeholder="If you think adventure is dangerous, try routine, it’s lethal. – Paulo Coelho" value="" data-msg="Please enter text">
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-floating mb-0">
                                                    <textarea data-length="158" name="meta_desc" class="form-control char-textarea" id="textarea-counter" rows="2" placeholder="Meta Description" style="height: 50px"></textarea>
                                                </div>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-floating mb-0">
                                                    <textarea data-length="250" name="meta_keywords" class="form-control char-textarea" id="textarea-counter2" rows="2" placeholder="Meta Keywords" style="height: 50px"></textarea>
                                                </div>
