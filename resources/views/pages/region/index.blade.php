              ...
              <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                  ...
                  <div class="card-title">
                      ...
                      <div class="d-flex align-items-center position-relative my-1">
                          ...
                          <!--end::Svg Icon-->
                          <input type="text" data-kt-ecommerce-order-filter="search" class="form-control form-control-solid w-250px ps-14" placeholder="Search Region" />
                      </div>
                      <!--end::Search-->
                  </div>
                  <!--end::Card title-->
                  ...
                  <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
                      ...
                      <thead>
                          ...
                          <tr class="text-start text-gray-400 fw-bolder fs-7 text-uppercase gs-0">
                              ...
                              <th class="">Region Title</th>
                              <th class="">Url Slug</th>
                              <th class="">Action</th>
                          </tr>
                          <!--end::Table row-->
                      </thead>
                      ...
                      <tbody class="fw-bold text-gray-600">
                          ...
                          <tr>
                                      ...
                                      <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                          <a href="../../demo1/dist/apps/user-management/users/view.html">
                                              <div class="symbol-label">
                                                  <img src="{{asset('images/'. $item->thumbnail_image)}}" alt="Max Smith" class="w-100" />
                                              </div>
                                          </a>
                                      </div>
                                  </div>
                            ...
                            <td class="" data-order="2022-01-12">
                                <span class="fw-bolder">{{$item->url_slug}}</span>
                            </td>
