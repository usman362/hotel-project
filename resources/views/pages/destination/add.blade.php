                                ...
                                <form class="validate-form mt-2 pt-50" novalidate="novalidate">
                                    <div class="row">
                                        <div class="col-12 col-sm-3 mb-1">
                                            ...
                                            <input type="text" class="form-control" id="name" name="title" placeholder="Nepal" data-msg="Please enter destination name">
                                        </div>
                                        <div class="col-12 col-sm-3 mb-1">
                                            <label class="form-label" for="accountLastName">URL Slug</label>
                                            <input type="text" class="form-control" id="url" name="url_slug" placeholder="/nepal" value="" data-msg="Please enter URL">
                                        </div>
                                        <div class="col-12 col-sm-3 mb-1">
                                            <label class="form-label" for="latitude">Latitude</label>
                                            <input type="text" class="form-control" id="latitude" name="latitude" placeholder="27.717245" value="" data-msg="Please enter latitude">
                                        </div>
                                        <div class="col-12 col-sm-3 mb-1">
                                            <label class="form-label" for="longitude">Longitude</label>
                                            <input type="text" class="form-control" id="" name="longitude" placeholder="85.323959" value="" data-msg="Please enter longitude">
                                        </div>
                                        ...
                                        <div class="col-12 mb-1">
                                            ...
                                            <input type="text" class="form-control" id="" name="banner_text" placeholder="I may have been born in another place, but I feel I am from Nepal. The Magic of Nepal has to be felt. ― Avijeet Das" value="" data-msg="Please enter text">
                                        </div>
                                        <div class="col-12 mb-1">
                                            <div id="full-wrapper">
                                        ...
                                        <div class="col-md-12 mb-1">
                                            ...
                                            <input type="text" class="form-control" id="" name="widget_code" placeholder="Enter widget code here" value="" data-msg="Please enter widget code">
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-6">
                                                ...
                                                <div class="form-floating mb-0">
                                                    <textarea data-length="60" class="form-control char-textarea" name="meta_title" id="textarea-counter1" rows="1" placeholder="Meta Title" style="height: 25px"></textarea>
                                                </div>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-floating mb-0">
                                                    <textarea data-length="158" class="form-control char-textarea" name="meta_desc" id="textarea-counter" rows="2" placeholder="Meta Description" style="height: 50px"></textarea>
                                                </div>
                                            ...
                                            <div class="col-12">
                                                ...
                                                <div class="form-floating mb-0">
                                                    <textarea data-length="250" class="form-control char-textarea" name="meta_keywords" id="textarea-counter2" rows="2" placeholder="Meta Keywords" style="height: 50px"></textarea>
                                                </div>
