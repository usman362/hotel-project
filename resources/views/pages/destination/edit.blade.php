...
<div class="content d-flex flex-column flex-column-fluid" id="kt_content">
    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div  data-kt-swapper-parent="{default: '#kt_content_container', 'lg': '#kt_toolbar_container'}" class="page-title d-flex align-items-center flex-wrap me-3 mb-5 mb-lg-0">
                <!--begin::Title-->
                <h1 class="d-flex text-dark fw-bolder fs-3 align-items-center my-1">Update Destination</h1>
                <!--end::Title-->
                <!--begin::Separator-->
                ...
                <ul class="breadcrumb breadcrumb-separatorless fw-bold fs-7 my-1">
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">Destination</li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item">
                        <span class="bullet bg-gray-300 w-5px h-2px"></span>
                    ...
                    <!--end::Item-->
                    <!--begin::Item-->
                    <li class="breadcrumb-item text-muted">Update Destination</li>
                    <!--end::Item-->
                    <!--begin::Item-->
                    {{-- <li class="breadcrumb-item">
                        <span class="bullet bg-gray-300 w-5px h-2px"></span>
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        ...
        <div id="kt_content_container" class="container-xxl">
            <form id="kt_ecommerce_add_category_form" method="POST" action="{{route('destination.update', $destination->id)}}" enctype="multipart/form-data" class="form d-flex flex-column flex-lg-row">
                @csrf   
                <!--begin::Aside column-->
                <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body text-center pt-0">
                            @if ($destination->thumbnail_image && !empty($destination->thumbnail_image))
                            <div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true" style="background-image: url('{{asset('images/'.$destination->thumbnail_image)}}')">
                            @else
                            ...
                            <!--end::Image input-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">Set the Destination thumbnail image. Only *.png, *.jpg and *.jpeg image files are accepted</div>
                            <!--end::Description-->
                        </div>
                        <!--end::Card body-->
                    </div>
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mt-10">
                                ...
                                <input class="form-control" name="longitude" id="longitude" placeholder="longitude" value="{{$destination->longitude}}" />
                            </div>
                            <div class="mt-10">
                                <label for="latitude" class="form-label">Latitude</label>
                                <input class="form-control" name="latitude" id="latitude" placeholder="Latitude" value="{{$destination->latitude}}" />
                            </div>
                            <!--end::Datepicker-->
                        </div>
                        <!--end::Card body-->
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body text-center pt-0">
                            <!--begin::Image input-->
                            @if ($destination->banner_image && !empty($destination->banner_image))
                            <div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true" style="background-image: url('{{asset('images/'.$destination->banner_image)}}')">
                            @else
                            <div class="image-input image-input-empty image-input-outline mb-3" data-kt-image-input="true" style="background-image: url('https://preview.keenthemes.com/metronic8/demo1/assets/media/svg/files/blank-image.svg')">
                            @endif
                                <!--begin::Preview existing avatar-->
                            ...
                            <!--end::Image input-->
                            <!--begin::Description-->
                            <div class="text-muted fs-7">Set the Destination Banner image. Only *.png, *.jpg and *.jpeg image files are accepted</div>
                            <!--end::Description-->
                        </div>
                        <!--end::Card body-->
                    </div>
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="title" class="form-control mb-2" placeholder="Destination name" value="{{$destination->title}}" />
                                <!--end::Input-->
                                <!--begin::Description-->
                            ...
                            <div class="mb-10 fv-row">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" name="url_slug" class="form-control mb-2" placeholder="URL Slug" value="{{$destination->url_slug}}" />
                                <!--end::Input-->
                                <!--begin::Description-->
                                {{-- <div class="text-muted fs-7">A category name is required and recommended to be unique.</div> --}}
                                <!--end::Description-->
                            ...
                            <div>
                                ...
                                <textarea name="description" class="form-control" id="" cols="30" rows="5">{{$destination->description}}</textarea>
                                <!--end::Editor-->
                                <!--begin::Description-->
                    ...
                    <div class="card card-flush py-4">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="mb-10">
                                ...
                                <!--end::Label-->
                                <!--begin::Input-->
                                <input type="text" class="form-control mb-2" name="meta_title" placeholder="Meta tag name" value="{{$destination->meta_title}}" />
                                <!--end::Input-->
                                <!--begin::Description-->
                            ...
                            <div class="mb-10">
                                ...
                                <textarea name="meta_desc" class="form-control" id="" cols="30" rows="5">{{$destination->meta_desc}}</textarea>
                                <!--end::Editor-->
                                <!--begin::Description-->
                            ...
                            <div>
                                ...
                                <!--end::Label-->
                                <!--begin::Editor-->
                                <input id="kt_ecommerce_add_category_meta_keywords" name="meta_keywords" class="form-control mb-2" value="{{$destination->meta_keywords}}" />
                                <!--end::Editor-->
                                <!--begin::Description-->
