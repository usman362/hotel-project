                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="d-flex">
                                            ...
                                            <a href="#" class="me-25">
                                                <img src="{{asset($destination->thumbnail->file_name ?? '')}}" id="thumbnail_image_output" class="uploadedAvatar rounded me-50" alt="profile image" height="100" width="100">
                                            </a>
                                            ...
                                            <div class="d-flex align-items-end mt-75 ms-1">
                                                <div>
                                                    ...
                                                    <input type="hidden" name="thumbnail_image" value="{{$destination->thumbnail_image}}">
                                    ...
                                    <div class="col-md-6">
                                        <div class="d-flex">
                                            ...
                                            <a href="#" class="me-25">
                                                <img src="{{asset($destination->banner->file_name ?? '')}}" id="banner_image_output" class="uploadedAvatar rounded me-50" alt="profile image" height="100" width="100">
                                            </a>
                                            ...
                                            <div class="d-flex align-items-end mt-75 ms-1">
                                                <div>
                                                    ...
                                                    <input type="hidden" name="banner_image" value="{{$destination->banner_image}}">
