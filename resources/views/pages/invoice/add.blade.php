                                ...
                                <div class="d-flex justify-content-between flex-md-row flex-column invoice-spacing mt-0">
                                    ...
                                    <div class="invoice-number-date mt-md-0 mt-2">
                                        ...
                                        <div class="d-flex align-items-center mb-1">
                                            ...
                                            <input type="text" name="date" class="form-control invoice-edit-input flatpickr-basic" />
                                        </div>
                                        <div class="d-flex align-items-center">
                                            <span class="title">Due Date:</span>
                                            <input type="text" name="due_date" class="form-control invoice-edit-input flatpickr-basic" />
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <table>
                                            <tbody>
                                                ...
                                                <tr>
                                                    ...
                                                    <td><input type="text" class="form-control invoice-edit-input" name="bank_name" placeholder="American Bank" /></td>
                                                </tr>
                                                <tr>
                                                    <td class="pe-1">Country:</td>
                                                    <td><input type="text" class="form-control invoice-edit-input" name="country" placeholder="United States" /></td>
                                                </tr>
                                                <tr>
                                                    <td class="pe-1">IBAN:</td>
                                                    <td><input type="text" class="form-control invoice-edit-input" name="iban" placeholder="ETD95476213874685" /></td>
                                                </tr>
                                                <tr>
                                                    <td class="pe-1">SWIFT code:</td>
                                                    <td><input type="text" class="form-control invoice-edit-input" name="swift_code" placeholder="BR91905" /></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                    </div>
                                ...
                                <div class="row invoice-sales-total-wrapper">
                                    <div class="col-md-6 order-md-1 order-2 mt-md-0 mt-3">
                                        <div class="d-flex align-items-center mb-1">
                                            ...
                                            <input type="text" class="form-control ms-50" id="salesperson" name="sales_person" placeholder="Edward Crowley" />
                                        </div>
                                    </div>
                            ...
                            <div class="invoice-terms mt-1">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="form-check form-switch">
                                        <input type="checkbox" class="form-check-input" name="payment_terms" checked id="paymentTerms" />
                                ...
                                <div class="d-flex justify-content-between py-1">
                                    ...
                                    <div class="form-check form-switch">
                                        <input type="checkbox" class="form-check-input" name="client_notes" checked id="clientNotes" />
                                ...
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div class="form-check form-switch">
                                        <input type="checkbox" class="form-check-input" name="payment_sub" id="paymentStub" />
