    ...
    <div class="modal-dialog modal-dialog-centered" style="max-width: 991px;">
        <div class="modal-content">
                            ...
                            <div class="content-body">
                                ...
                                <div class="file-manager-main-content">
                                    ...
                                    <div class="file-manager-content-body">
                                        <form action="{{ route('uploaded-files.store') }}" method="post"
                                            id="upload_form" enctype="multipart/form-data">
                                            @csrf
                                            <input type="file" class="form-control" id="upload_file" name="aiz_file"
                                        ...
                                        <form action="" id="uploaded_image_form">
                                            <div class="view-container row mt-2" id="image_preview">
                                                ...
                                                @forelse ($all_uploads as $key => $file)
                                                    ...
                                                    <div class="col-md-3">
                                                        <label class="card file-manager-item file"
                                                            for="upload{{ $file->id }}">
                                                            <div class="form-check">
                                                                <input type="radio" name="selectImage"
                                                                    class="form-check-input checkImage"
                                                                    id="upload{{ $file->id }}"
                                                                    value="{{ $file->id }}" />
                                                            </div>
                                                            <div class="card-img-top file-logo-wrapper">
                                                                ...
                                                                <div
                                                                    ...
                                                                    <img class="uploaded_image{{ $file->id }}"
                                                                        src="{{ asset($file->file_name) }}"
                                                                        alt="" height="50" />
                                                                </div>
                                                            </div>
                                                            <div class="card-body">
                                                                <div class="content-wrapper">
                                                                    <p class="card-text file-name mb-0">
                                                                        {{ $file_name . '.' . $file->extension }}</p>

                                                                    <p class="card-text file-size mb-0">
                                                                        {{ formatBytes($file->file_size) }}</p>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary me-1 selectUploadImage"
        ...
        $('#upload_form').on('submit', function(event) {
          ...
          <div class="col-md-3">
            <label class="card file-manager-item file" for="upload` + data.upload.id + `">
                <div class="form-check">
                    <input type="radio" name="selectImage" class="form-check-input checkImage" id="upload` + data
                        .upload.id + `" value="` + data.upload.id + `"/>
                </div>
                <div class="card-img-top file-logo-wrapper">
                ...
                <div class="card-body">
                    <div class="content-wrapper">
                        <p class="card-text file-name mb-0">` + data.upload.file_original_name + `.` + data.upload
                        .extension + `</p>
