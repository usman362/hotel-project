...
<div class="card {{ $class }}">
    ...
    <div class="card-header border-0 bg-{{ $chartColor }} py-5">
        <h3 class="card-title fw-bolder text-white">Main section</h3>
        ...
        <div class="card-p mt-n20 position-relative">
            ...
            <div class="row g-0">
                ...
                <div class="col bg-light-warning px-6 py-8 rounded-2 me-7 mb-7">
                    <span class="text-warning fw-bold fs-6 float-right">2</span>
                ...
                <div class="col bg-light-primary px-6 py-8 rounded-2 mb-7">
                   <span class="text-primary fw-bold fs-6 float-right">{{count($booking)}}</span>
            ...
            <div class="row g-0">
                ...
                <div class="col bg-light-danger px-6 py-8 rounded-2 me-7">
                    <span class="text-danger fw-bold fs-6 float-right">4</span>
                ...
                <div class="col bg-light-success px-6 py-8 rounded-2">
                   <span class="text-success fw-bold fs-6 float-right">5</span>
